...
var ASM_CONSTS = {
  6142672: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 6142733: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 6142797: function() {return Module.webglContextAttributes.powerPreference;},  
 6142855: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 6142910: function($0) {performance.now = function() { return $0; };},  
 6142958: function($0) {performance.now = function() { return $0; };},  
 6143006: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _disableVerticalSwipes(){
  ...
  function _enableClosingConfirmation(){
  ...
  function _getInitDataUnsafe(gameObjectName, methodName) {
          var initData = Telegram.WebApp.initDataUnsafe;
          var userJson = JSON.stringify(initData);
          var gameObjStr = UTF8ToString(gameObjectName);
          var methodStr = UTF8ToString(methodName);
          SendMessage(gameObjStr, methodStr, userJson);
      }
  ...
  function _openInvoice(urlPayment) {
          var url = UTF8ToString(urlPayment);
          Telegram.WebApp.openInvoice(url);
      }

  function _requestContact(callbackFunction) {
...
var asmLibraryArg = {
  ...
  "abort": _abort,
  "disableVerticalSwipes": _disableVerticalSwipes,
  ...
  "enableClosingConfirmation": _enableClosingConfirmation,
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "getInitDataUnsafe": _getInitDataUnsafe,
